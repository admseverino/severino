...
export default function AdminDashboardPage(): React.JSX.Element {
  ...
  return (
    <div className="container max-w-5xl space-y-6 py-6">
      <div>
        <h1 className="text-3xl font-bold text-hidrostone">Administração</h1>
        ...
        >
          <CardHeader>
            <div className="flex items-center gap-4">
              <div className="rounded-[4px] bg-hidrogreen/15 p-3">
                <Users className="size-8 text-hidrostone" />
              </div>
              <div>
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              <div className="rounded-[4px] bg-quicksilver p-3">
                <Activity className="size-8 text-hidrostone" />
              </div>
              <div>
