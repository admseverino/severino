  ...
  return (
    <main className="container flex flex-col items-center justify-center gap-8 py-16 text-center">
      <div className="max-w-2xl space-y-6">
        <Image
          src="/Assets/severino_logo_0.png"
          alt="Severino"
          width={480}
          height={160}
          ...
          priority
        />
        <h1 className="text-3xl md:text-4xl font-extrabold text-severinostone">
      ...
      {session?.user ? null : (
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Button asChild variant="outline" className="rounded-[4px] border-severinostone text-severinostone">
