      ...
      <header className="space-y-3">
        <div className="flex flex-wrap items-baseline justify-between gap-3">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold text-severinostone">Medidores</h1>
...
function Stat({
  ...
  return (
    <div className="rounded-[4px] border bg-card p-3">
      ...
      <p className="mt-1 text-2xl font-bold text-severinostone" data-testid={testId}>
        {value}
      </p>
    </div>
  )
      ...
      <div className="rounded-[4px] border bg-card p-4 text-sm">
        {isStaff ? (
          <p>
            ...
            <Link href="/onboarding" className="text-severinogreen underline-offset-2 hover:underline">
              /onboarding
            </Link>
            .
          </p>
