    ...
    <div className="space-y-6 py-6 print:space-y-0 print:py-0" data-testid="meters-print-page">
      <div className="container max-w-5xl space-y-3 print:hidden">
        <header className="space-y-1">
          <h1 className="text-3xl font-bold text-severinostone">Impressão de QR Codes</h1>
  ...
  return (
    ...
    >
      <header className="mb-4 print:mb-3">
        ...
        <h2 className="text-xl font-bold uppercase text-severinostone print:text-black">{title}</h2>
      </header>
  ...
  return (
    <section data-testid="print-masters-section" className="print:break-before-page">
      <header className="mb-4 print:mb-3">
        ...
        <h2 className="text-xl font-bold uppercase text-severinostone print:text-black">
