...
export function AppSidebar(): React.JSX.Element {
  ...
  const linkBody = (item: AppNavItem, Icon: LucideIcon, active: boolean): React.JSX.Element => (
    <span
      className={cn(
        ...
        active ? 'bg-severinogreen text-white' : 'text-foreground hover:bg-quicksilver',
  ...
  return (
    ...
    >
      ...
      >
        {!collapsed ? (
          <span className="truncate text-xs font-bold uppercase tracking-wide text-severinostone">Menu</span>
        ) : null}
        {!collapsed ? (
          <Button
            type="button"
