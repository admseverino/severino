...
export function QrLabel({
  ...
  return (
    <article
      ...
      className="flex break-inside-avoid flex-col items-center gap-1.5 rounded-[4px] border border-severinostone/40 bg-white p-2 text-center text-severinostone print:border-black print:bg-white print:text-black"
    >
