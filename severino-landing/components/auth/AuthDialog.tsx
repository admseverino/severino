    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {activeTab === 'login'
              ? 'Acesse o painel Severino com seu e-mail.'
              : 'Crie uma conta para acessar o painel Severino.'}
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="login" className="space-y-4">
            ...
            <form className="space-y-4" noValidate onSubmit={(e) => void onLogin(e)}>
              ...
              <Button
                ...
                className="w-full rounded-[4px] bg-severinostone font-bold uppercase text-white hover:bg-severinostone/90"
                disabled={isBusy}
              >
          ...
          <TabsContent value="register" className="space-y-4">
            ...
            <form className="space-y-4" noValidate onSubmit={(e) => void onRegister(e)}>
              ...
              <Button
                ...
                className="w-full rounded-[4px] bg-severinogreen font-bold uppercase text-white hover:bg-severinogreen/90"
                disabled={isBusy}
              >
