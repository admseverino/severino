  ...
  if (committed) {
    return (
      <Card data-testid="onboarding-success" className="rounded-[4px]">
        <CardHeader>
          <CardTitle className="text-severinogreen">Onboarding concluído</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild className="rounded-[4px] bg-severinostone text-white hover:bg-severinostone/90">
      ...
      <CardContent>
        <form className="space-y-5" onSubmit={(e) => void onSubmit(e)} noValidate>
          ...
          <div className="space-y-2">
            ...
            <button
              type="button"
              className="text-xs text-severinogreen underline-offset-2 hover:underline"
  ...
  return (
    <li className="px-4 py-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="font-semibold text-severinostone" style={{ paddingLeft: depth * 12 }}>
          {group.name}
        </div>
    ...
    <div className="space-y-6" data-testid="onboarding-preview">
            ...
            <ul className="divide-y rounded-[4px] border">
              {masters.map((m) => (
                <li key={m.id} className="flex flex-wrap items-center justify-between gap-2 px-4 py-3">
                  <span className="font-mono text-xs uppercase tracking-wide text-severinostone">
                    master · {m.targetKind}
                  </span>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button
          ...
          className="rounded-[4px] bg-severinogreen font-bold uppercase text-white hover:bg-severinogreen/90"
          disabled={submitting === 'commit'}
...
function StatTile({ label, value, testId }: StatTileProps): React.JSX.Element {
  return (
    <div className="rounded-[4px] border bg-card p-3">
      ...
      <div className="mt-1 text-2xl font-bold text-severinostone" data-testid={testId}>
        {value}
      </div>
    </div>
  )
